...
const fallbackQuizzes: RandomQuiz[] = [
  {
    ...
    hint: "Ищи длинную дорожку с ярко-красными воротами на горе.",
    stickers: ["🇯🇵", "⛩️", "🗻", "🌸"],
  ...
  },
  {
    ...
    hint: "Это беломраморное здание стоит рядом с рекой Ямуна.",
    stickers: ["🇮🇳", "🕌", "🪷", "🌶️"],
  ...
  },
  {
    ...
    hint: "Название связано с царским шатром.",
    stickers: ["🇰🇿", "🏕️", "🌾", "🏙️"],
  ...
  },
  {
    ...
    hint: "Это железная башня с четырьмя опорами, стоящая в Париже.",
    stickers: ["🇫🇷", "🗼", "🥐", "🎨"],
  ...
  },
  {
    ...
    hint: "Это овальный каменный амфитеатр с арками в центре Рима.",
    stickers: ["🇮🇹", "🏛️", "🍝", "🎭"],
  ...
  },
  {
    ...
    hint: "Это очень длинная стена, которая идёт по холмам и горам.",
    stickers: ["🇨🇳", "🐉", "🏮", "⛩️"],
  ...
  },
  {
    ...
    hint: "У этой статуи в поднятой руке факел.",
    stickers: ["🇺🇸", "🗽", "🌉", "🏙️"],
  ...
  },
  {
    ...
    hint: "Эта статуя стоит высоко над городом и раскинула руки в стороны.",
    stickers: ["🇧🇷", "🗿", "🌴", "⚽"],
  ...
  },
  {
    ...
    hint: "У этого моста две башни и верхняя пешеходная галерея.",
    stickers: ["🇬🇧", "🏰", "🎡", "☂️"],
  ...
  },
  {
    ...
    hint: "У этой фигуры тело льва и человеческая голова.",
    stickers: ["🇪🇬", "𓂀", "🏜️", "☀️"],
  ...
  },
  {
    ...
    hint: "Это храм с колоннами, стоящий на холме Акрополь.",
    stickers: ["🇬🇷", "🏛️", "🌊", "🫒"],
  ...
  },
  {
    ...
    hint: "У этого собора высокие башни и очень необычные фасады.",
    stickers: ["🇪🇸", "🏰", "🎨", "🌊"],
  ...
  },
  {
    ...
    hint: "У здания большой центральный купол и минареты вокруг.",
    stickers: ["🇹🇷", "🕌", "🌉", "☕"],
  ...
  },
  {
    ...
    hint: "Это ступенчатая пирамида с лестницами по сторонам.",
    stickers: ["🇲🇽", "🌵", "🛕", "🎺"],
  ...
  },
  {
    ...
    hint: "Это каменный город на высокой горной террасе.",
    stickers: ["🇵🇪", "⛰️", "🛕", "☀️"],
  ...
  },
  {
    ...
    hint: "Крыши этого здания похожи на белые паруса у воды.",
    stickers: ["🇦🇺", "🪃", "🏛️", "🌊"],
  ...
  },
  {
    ...
    hint: "Это белый сказочный замок на холме среди гор.",
    stickers: ["🇩🇪", "🏰", "🎻", "🌲"],
  ...
  },
  {
    ...
    hint: "Это очень тонкая и самая высокая башня в Дубае.",
    stickers: ["🇦🇪", "🏙️", "🏜️", "✨"],
...
export const getRandomGeminiQuiz = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    const prompt = [
      ...
      "Add one clear Russian hint with a visual clue: shape, color, location, material, or a famous detail.",
      "The hint must help a student but must not reveal the exact landmark name.",
      ...
      '  "hint": "One short Russian hint without the answer",',
